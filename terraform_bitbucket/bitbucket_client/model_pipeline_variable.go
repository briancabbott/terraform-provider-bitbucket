...
// PipelineVariable struct for PipelineVariable
...
func NewPipelineVariable(type_ string) *PipelineVariable {
	this := PipelineVariable{}
	this.Type = type_
	return &this
}
...
func (v NullablePipelineVariable) Get() *PipelineVariable {
	return v.value
}

func (v *NullablePipelineVariable) Set(val *PipelineVariable) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePipelineVariable(val *PipelineVariable) *NullablePipelineVariable {
	return &NullablePipelineVariable{value: val, isSet: true}
}
