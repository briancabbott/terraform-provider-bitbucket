...
func NewPaginatedPullrequestComments() *PaginatedPullrequestComments {
	this := PaginatedPullrequestComments{}
	return &this
}
...
type NullablePaginatedPullrequestComments struct {
	value *PaginatedPullrequestComments
	isSet bool
}

func (v NullablePaginatedPullrequestComments) Get() *PaginatedPullrequestComments {
	return v.value
}

func (v *NullablePaginatedPullrequestComments) Set(val *PaginatedPullrequestComments) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedPullrequestComments) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedPullrequestComments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedPullrequestComments(val *PaginatedPullrequestComments) *NullablePaginatedPullrequestComments {
	return &NullablePaginatedPullrequestComments{value: val, isSet: true}
}
