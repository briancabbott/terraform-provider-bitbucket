...
type NullablePaginatedSshUserKeys struct {
	value *PaginatedSshUserKeys
	isSet bool
}

func (v NullablePaginatedSshUserKeys) Get() *PaginatedSshUserKeys {
	return v.value
}

func (v *NullablePaginatedSshUserKeys) Set(val *PaginatedSshUserKeys) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedSshUserKeys) IsSet() bool {
	return v.isSet
}
...
func NewNullablePaginatedSshUserKeys(val *PaginatedSshUserKeys) *NullablePaginatedSshUserKeys {
	return &NullablePaginatedSshUserKeys{value: val, isSet: true}
}
