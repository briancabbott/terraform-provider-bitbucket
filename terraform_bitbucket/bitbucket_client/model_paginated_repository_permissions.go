...
func NewPaginatedRepositoryPermissions() *PaginatedRepositoryPermissions {
	this := PaginatedRepositoryPermissions{}
	return &this
}
...
type NullablePaginatedRepositoryPermissions struct {
	value *PaginatedRepositoryPermissions
	isSet bool
}

func (v NullablePaginatedRepositoryPermissions) Get() *PaginatedRepositoryPermissions {
	return v.value
}

func (v *NullablePaginatedRepositoryPermissions) Set(val *PaginatedRepositoryPermissions) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedRepositoryPermissions) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedRepositoryPermissions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedRepositoryPermissions(val *PaginatedRepositoryPermissions) *NullablePaginatedRepositoryPermissions {
	return &NullablePaginatedRepositoryPermissions{value: val, isSet: true}
}
