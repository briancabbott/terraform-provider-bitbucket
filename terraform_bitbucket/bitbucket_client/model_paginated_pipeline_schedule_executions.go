...
func NewPaginatedPipelineScheduleExecutions() *PaginatedPipelineScheduleExecutions {
	this := PaginatedPipelineScheduleExecutions{}
	return &this
}
...
func (o *PaginatedPipelineScheduleExecutions) GetValues() []PipelineScheduleExecution {
	if o == nil || o.Values == nil {
		var ret []PipelineScheduleExecution
		return ret
	}
	return *o.Values
}
...
func (o *PaginatedPipelineScheduleExecutions) HasNext() bool {
	if o != nil && o.Next != nil {
		return true
	}
...
type NullablePaginatedPipelineScheduleExecutions struct {
	value *PaginatedPipelineScheduleExecutions
	isSet bool
}

func (v NullablePaginatedPipelineScheduleExecutions) Get() *PaginatedPipelineScheduleExecutions {
	return v.value
}

func (v *NullablePaginatedPipelineScheduleExecutions) Set(val *PaginatedPipelineScheduleExecutions) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedPipelineScheduleExecutions) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedPipelineScheduleExecutions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedPipelineScheduleExecutions(val *PaginatedPipelineScheduleExecutions) *NullablePaginatedPipelineScheduleExecutions {
	return &NullablePaginatedPipelineScheduleExecutions{value: val, isSet: true}
}

func (v NullablePaginatedPipelineScheduleExecutions) MarshalJSON() ([]byte, error) {
