...
type NullablePaginatedCommitComments struct {
	value *PaginatedCommitComments
	isSet bool
}

func (v NullablePaginatedCommitComments) Get() *PaginatedCommitComments {
	return v.value
}

func (v *NullablePaginatedCommitComments) Set(val *PaginatedCommitComments) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedCommitComments) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedCommitComments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedCommitComments(val *PaginatedCommitComments) *NullablePaginatedCommitComments {
	return &NullablePaginatedCommitComments{value: val, isSet: true}
}
