...
type NullablePaginatedIssues struct {
	value *PaginatedIssues
	isSet bool
}

func (v NullablePaginatedIssues) Get() *PaginatedIssues {
	return v.value
}

func (v *NullablePaginatedIssues) Set(val *PaginatedIssues) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePaginatedIssues(val *PaginatedIssues) *NullablePaginatedIssues {
	return &NullablePaginatedIssues{value: val, isSet: true}
}
