...
type NullablePaginatedDeployKeys struct {
	value *PaginatedDeployKeys
	isSet bool
}

func (v NullablePaginatedDeployKeys) Get() *PaginatedDeployKeys {
	return v.value
}

func (v *NullablePaginatedDeployKeys) Set(val *PaginatedDeployKeys) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedDeployKeys) IsSet() bool {
	return v.isSet
}
...
func NewNullablePaginatedDeployKeys(val *PaginatedDeployKeys) *NullablePaginatedDeployKeys {
	return &NullablePaginatedDeployKeys{value: val, isSet: true}
}
