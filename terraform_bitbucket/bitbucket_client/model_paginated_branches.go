...
type NullablePaginatedBranches struct {
	value *PaginatedBranches
	isSet bool
}

func (v NullablePaginatedBranches) Get() *PaginatedBranches {
	return v.value
}

func (v *NullablePaginatedBranches) Set(val *PaginatedBranches) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePaginatedBranches(val *PaginatedBranches) *NullablePaginatedBranches {
	return &NullablePaginatedBranches{value: val, isSet: true}
}
