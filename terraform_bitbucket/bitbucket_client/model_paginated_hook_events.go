...
type NullablePaginatedHookEvents struct {
	value *PaginatedHookEvents
	isSet bool
}

func (v NullablePaginatedHookEvents) Get() *PaginatedHookEvents {
	return v.value
}

func (v *NullablePaginatedHookEvents) Set(val *PaginatedHookEvents) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedHookEvents) IsSet() bool {
	return v.isSet
}
...
func NewNullablePaginatedHookEvents(val *PaginatedHookEvents) *NullablePaginatedHookEvents {
	return &NullablePaginatedHookEvents{value: val, isSet: true}
}
