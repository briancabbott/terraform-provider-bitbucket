...
func NewPipelineStepStateCompletedErrorAllOf() *PipelineStepStateCompletedErrorAllOf {
	this := PipelineStepStateCompletedErrorAllOf{}
	return &this
}
...
type NullablePipelineStepStateCompletedErrorAllOf struct {
	value *PipelineStepStateCompletedErrorAllOf
	isSet bool
}

func (v NullablePipelineStepStateCompletedErrorAllOf) Get() *PipelineStepStateCompletedErrorAllOf {
	return v.value
}

func (v *NullablePipelineStepStateCompletedErrorAllOf) Set(val *PipelineStepStateCompletedErrorAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullablePipelineStepStateCompletedErrorAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullablePipelineStepStateCompletedErrorAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePipelineStepStateCompletedErrorAllOf(val *PipelineStepStateCompletedErrorAllOf) *NullablePipelineStepStateCompletedErrorAllOf {
	return &NullablePipelineStepStateCompletedErrorAllOf{value: val, isSet: true}
}

func (v NullablePipelineStepStateCompletedErrorAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePipelineStepStateCompletedErrorAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
