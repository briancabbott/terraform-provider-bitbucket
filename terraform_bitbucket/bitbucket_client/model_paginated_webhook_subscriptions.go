...
func NewPaginatedWebhookSubscriptions() *PaginatedWebhookSubscriptions {
	this := PaginatedWebhookSubscriptions{}
	return &this
}
...
type NullablePaginatedWebhookSubscriptions struct {
	value *PaginatedWebhookSubscriptions
	isSet bool
}

func (v NullablePaginatedWebhookSubscriptions) Get() *PaginatedWebhookSubscriptions {
	return v.value
}

func (v *NullablePaginatedWebhookSubscriptions) Set(val *PaginatedWebhookSubscriptions) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedWebhookSubscriptions) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedWebhookSubscriptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedWebhookSubscriptions(val *PaginatedWebhookSubscriptions) *NullablePaginatedWebhookSubscriptions {
	return &NullablePaginatedWebhookSubscriptions{value: val, isSet: true}
}
