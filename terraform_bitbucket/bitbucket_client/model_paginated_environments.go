...
type NullablePaginatedEnvironments struct {
	value *PaginatedEnvironments
	isSet bool
}

func (v NullablePaginatedEnvironments) Get() *PaginatedEnvironments {
	return v.value
}

func (v *NullablePaginatedEnvironments) Set(val *PaginatedEnvironments) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedEnvironments) IsSet() bool {
	return v.isSet
}
...
func NewNullablePaginatedEnvironments(val *PaginatedEnvironments) *NullablePaginatedEnvironments {
	return &NullablePaginatedEnvironments{value: val, isSet: true}
}
