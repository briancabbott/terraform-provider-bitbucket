...
// NewPaginatedIssueAttachments instantiates a new PaginatedIssueAttachments object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPaginatedIssueAttachments() *PaginatedIssueAttachments {
	this := PaginatedIssueAttachments{}
	return &this
}

// NewPaginatedIssueAttachmentsWithDefaults instantiates a new PaginatedIssueAttachments object
...
type NullablePaginatedIssueAttachments struct {
	value *PaginatedIssueAttachments
	isSet bool
}

func (v NullablePaginatedIssueAttachments) Get() *PaginatedIssueAttachments {
	return v.value
}

func (v *NullablePaginatedIssueAttachments) Set(val *PaginatedIssueAttachments) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedIssueAttachments) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedIssueAttachments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedIssueAttachments(val *PaginatedIssueAttachments) *NullablePaginatedIssueAttachments {
	return &NullablePaginatedIssueAttachments{value: val, isSet: true}
}
