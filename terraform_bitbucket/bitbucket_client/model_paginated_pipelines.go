...
type NullablePaginatedPipelines struct {
	value *PaginatedPipelines
	isSet bool
}

func (v NullablePaginatedPipelines) Get() *PaginatedPipelines {
	return v.value
}

func (v *NullablePaginatedPipelines) Set(val *PaginatedPipelines) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePaginatedPipelines(val *PaginatedPipelines) *NullablePaginatedPipelines {
	return &NullablePaginatedPipelines{value: val, isSet: true}
}
