...
type NullablePaginatedTreeentries struct {
	value *PaginatedTreeentries
	isSet bool
}

func (v NullablePaginatedTreeentries) Get() *PaginatedTreeentries {
	return v.value
}

func (v *NullablePaginatedTreeentries) Set(val *PaginatedTreeentries) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedTreeentries) IsSet() bool {
	return v.isSet
}
...
func NewNullablePaginatedTreeentries(val *PaginatedTreeentries) *NullablePaginatedTreeentries {
	return &NullablePaginatedTreeentries{value: val, isSet: true}
}
