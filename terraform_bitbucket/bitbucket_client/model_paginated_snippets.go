...
type NullablePaginatedSnippets struct {
	value *PaginatedSnippets
	isSet bool
}

func (v NullablePaginatedSnippets) Get() *PaginatedSnippets {
	return v.value
}

func (v *NullablePaginatedSnippets) Set(val *PaginatedSnippets) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePaginatedSnippets(val *PaginatedSnippets) *NullablePaginatedSnippets {
	return &NullablePaginatedSnippets{value: val, isSet: true}
}
