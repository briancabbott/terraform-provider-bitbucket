...
func (v NullablePaginatedFiles) Get() *PaginatedFiles {
	return v.value
}

func (v *NullablePaginatedFiles) Set(val *PaginatedFiles) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePaginatedFiles(val *PaginatedFiles) *NullablePaginatedFiles {
	return &NullablePaginatedFiles{value: val, isSet: true}
}
