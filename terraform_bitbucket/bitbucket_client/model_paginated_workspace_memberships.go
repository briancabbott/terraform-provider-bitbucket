...
func NewPaginatedWorkspaceMemberships() *PaginatedWorkspaceMemberships {
	this := PaginatedWorkspaceMemberships{}
	return &this
}
...
type NullablePaginatedWorkspaceMemberships struct {
	value *PaginatedWorkspaceMemberships
	isSet bool
}

func (v NullablePaginatedWorkspaceMemberships) Get() *PaginatedWorkspaceMemberships {
	return v.value
}

func (v *NullablePaginatedWorkspaceMemberships) Set(val *PaginatedWorkspaceMemberships) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedWorkspaceMemberships) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedWorkspaceMemberships) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedWorkspaceMemberships(val *PaginatedWorkspaceMemberships) *NullablePaginatedWorkspaceMemberships {
	return &NullablePaginatedWorkspaceMemberships{value: val, isSet: true}
}
