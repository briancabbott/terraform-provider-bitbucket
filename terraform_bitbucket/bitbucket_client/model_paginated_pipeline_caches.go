...
type NullablePaginatedPipelineCaches struct {
	value *PaginatedPipelineCaches
	isSet bool
}

func (v NullablePaginatedPipelineCaches) Get() *PaginatedPipelineCaches {
	return v.value
}

func (v *NullablePaginatedPipelineCaches) Set(val *PaginatedPipelineCaches) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedPipelineCaches) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedPipelineCaches) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedPipelineCaches(val *PaginatedPipelineCaches) *NullablePaginatedPipelineCaches {
	return &NullablePaginatedPipelineCaches{value: val, isSet: true}
}
