...
type NullablePaginatedPullrequests struct {
	value *PaginatedPullrequests
	isSet bool
}

func (v NullablePaginatedPullrequests) Get() *PaginatedPullrequests {
	return v.value
}

func (v *NullablePaginatedPullrequests) Set(val *PaginatedPullrequests) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedPullrequests) IsSet() bool {
	return v.isSet
}
...
func NewNullablePaginatedPullrequests(val *PaginatedPullrequests) *NullablePaginatedPullrequests {
	return &NullablePaginatedPullrequests{value: val, isSet: true}
}
