...
type NullablePaginatedVersions struct {
	value *PaginatedVersions
	isSet bool
}

func (v NullablePaginatedVersions) Get() *PaginatedVersions {
	return v.value
}

func (v *NullablePaginatedVersions) Set(val *PaginatedVersions) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePaginatedVersions(val *PaginatedVersions) *NullablePaginatedVersions {
	return &NullablePaginatedVersions{value: val, isSet: true}
}
