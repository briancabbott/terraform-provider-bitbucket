...
type NullablePaginatedDeployments struct {
	value *PaginatedDeployments
	isSet bool
}

func (v NullablePaginatedDeployments) Get() *PaginatedDeployments {
	return v.value
}

func (v *NullablePaginatedDeployments) Set(val *PaginatedDeployments) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedDeployments) IsSet() bool {
	return v.isSet
}
...
func NewNullablePaginatedDeployments(val *PaginatedDeployments) *NullablePaginatedDeployments {
	return &NullablePaginatedDeployments{value: val, isSet: true}
}
