...
type NullablePaginatedChangeset struct {
	value *PaginatedChangeset
	isSet bool
}

func (v NullablePaginatedChangeset) Get() *PaginatedChangeset {
	return v.value
}

func (v *NullablePaginatedChangeset) Set(val *PaginatedChangeset) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePaginatedChangeset(val *PaginatedChangeset) *NullablePaginatedChangeset {
	return &NullablePaginatedChangeset{value: val, isSet: true}
}
